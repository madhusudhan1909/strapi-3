...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-3f8jM3uu.mjs";
...
import { u as useWebhooks } from "./useWebhooks-ZUHQ_vCv.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-5BLBueQ7.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-eeESyfKo.mjs.map
