...
import { u as useConfiguration, a as useAuth, c as createTypedSelector, b as useOnce, d as createRoute, e as useInformationQuery, f as useGetMyPermissionsQuery, R as RBACProvider, N as NpsSurvey } from "./index-3f8jM3uu.mjs";
...
const dependencies = {
  ...
  "@strapi/icons": "1.19.0",
  "@strapi/permissions": "4.25.0",
  "@strapi/provider-audit-logs-local": "4.25.0",
  "@strapi/types": "4.25.0",
...
const devDependencies = {
  "@strapi/admin-test-utils": "4.25.0",
  "@strapi/data-transfer": "4.25.0",
  "@strapi/pack-up": "4.23.0",
  "@strapi/plugin-content-manager": "4.25.0",
...
const CM = React.lazy(
  () => import("./index-3f8jM3uu.mjs").then((n) => n.a0).then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(
  () => import("./HomePage-EUf20uE1.mjs").then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React.lazy(
  () => import("./InstalledPluginsPage-gFEspEgH.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React.lazy(
  () => import("./MarketplacePage-jbCcKN_R.mjs").then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React.lazy(
  () => import("./index-3f8jM3uu.mjs").then((n) => n.$).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React.lazy(
  () => import("./ProfilePage-8Qm_vzvi.mjs").then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React.lazy(
  () => import("./SettingsPage-SoK1XgVc.mjs").then((mod) => ({
...
//# sourceMappingURL=AuthenticatedApp-hRb3pfX6.mjs.map
