...
const useWebhooks = require("./useWebhooks-WS4yfDpS.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-lwi9U88A.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-hB39c4V0.js.map
